class Fire {
    ...
    update(game) {
        ...
        for (let i = 0; i < this.intensity; i++) {
            particles.createFire(this.x, this.y, this.intensity);
        }
        
        // 生成烟雾粒子
        if (Math.random() < 0.3) {
            particles.createSmoke(this.x, this.y - 20);
        }
    }
